...
const initialJuiceItems = [
  ...
  { id: "juice-passion", category: "juice", name: "百香果汁", spec: "750ml / 瓶", price: 120, note: "酸甜香氣明顯，適合調飲、甜點店", image: "/juice/passionfruit.jpg", active: true },
  ...
  { id: "juice-mango", category: "juice", name: "芒果汁", spec: "750ml / 瓶", price: 100, note: "香甜濃厚，熱帶風味明顯", image: "/juice/mango.jpg", active: true },
  ...
  { id: "juice-grapefruit", category: "juice", name: "葡萄柚汁", spec: "750ml / 瓶", price: 100, note: "微苦回甘，清爽有層次", image: "/juice/grapefruit.jpg", active: true },
...
const initialFruitItems = [
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。椰子依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/coconut.jpg",
    active: true,
    sortOrder: 1,
  },
  {
    id: "fruit-taiwan-grapefruit",
    category: "fruit",
    name: "台灣葡萄柚",
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。台灣葡萄柚依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/taiwan-grapefruit.jpg",
    active: true,
    sortOrder: 2,
  },
  {
    id: "fruit-imported-grapefruit",
    category: "fruit",
    name: "進口葡萄柚",
    spec: "單位：顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。進口葡萄柚依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/imported-grapefruit.jpg",
    active: true,
    sortOrder: 3,
  },
  {
    id: "fruit-taiwan-orange",
    category: "fruit",
    name: "台灣柳丁",
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。台灣柳丁依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/taiwan-orange.jpg",
    active: true,
    sortOrder: 4,
  },
  {
    id: "fruit-imported-sunkist",
    category: "fruit",
    name: "進口香吉士",
    spec: "單位：顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。進口香吉士依當日產地、大小、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。檸檬 A 級依當日產地、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。檸檬 B 級依當日產地、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。金桔依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/kumquat.jpg",
    active: true,
    sortOrder: 8,
  },
  {
    id: "fruit-imported-apple",
    category: "fruit",
    name: "進口蘋果",
    spec: "單位：顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。進口蘋果依當日產地、大小、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。芭樂 A 級依當日產地、大小、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。芭樂 B 級依當日產地、大小、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。奇異果依當日產地、大小、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。山蕉依當日產地、熟度、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "1號 / 2號 / 3號 / 4號",
    price: 0,
    note: "每日時價，請加 LINE 詢問。草莓依當日等級、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/strawberry.jpg",
    active: true,
    sortOrder: 14,
  },
  {
    id: "fruit-aiwen-mango",
    category: "fruit",
    name: "愛文芒果",
    spec: "15顆 / 18顆 / 20顆 / 24顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。愛文芒果依當日產地、顆數、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。金鑽鳳梨依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/golden-pineapple.jpg",
    active: true,
    sortOrder: 16,
  },
  {
    id: "fruit-cherry-tomato",
    category: "fruit",
    name: "小番茄",
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。小番茄依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/cherry-tomato.jpg",
    active: true,
    sortOrder: 17,
  },
  {
    id: "fruit-dragon-fruit-white",
    category: "fruit",
    name: "白肉火龍果",
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。白肉火龍果依當日產地、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/dragon-fruit-white.jpg",
    active: true,
    sortOrder: 18,
  },
  {
    id: "fruit-dragon-fruit-red",
    category: "fruit",
    name: "紅肉火龍果",
    spec: "單位：斤",
    price: 0,
    note: "每日時價，請加 LINE 詢問。紅肉火龍果依當日產地、大小、品質、數量與配送地區報價，運費另計。",
  ...
  },
  {
    ...
    spec: "單位：顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。紅肉木瓜依當日產地、熟度、大小、品質、數量與配送地區報價，運費另計。",
    image: "/fruit/red-papaya.jpg",
    active: true,
    sortOrder: 20,
  },
  {
    id: "fruit-watermelon-piece",
    category: "fruit",
    name: "西瓜",
    spec: "單位：顆",
    price: 0,
    note: "每日時價，請加 LINE 詢問。西瓜依當日產地、大小、甜度、品質、數量與配送地區報價，運費另計。",
...
export default function FruitJuiceWholesaleOrderPage() {
  ...
  const selectedItems = useMemo(() => {
    return items
      ...
      .filter((item) => item.category !== "fruit" && item.qty > 0);
  }, [items, quantities]);
...
function FruitDailyPriceNotice() {
  return (
    <div className="rounded-3xl border border-lime-100 bg-gradient-to-br from-lime-50 via-orange-50 to-white p-5 shadow-sm">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <p className="text-sm font-black text-lime-700">DAILY MARKET PRICE</p>
          <h3 className="mt-1 text-2xl font-black text-slate-900">水果每日時價｜請加 LINE 詢問</h3>
    ...
    <Card className="group overflow-hidden border-white/70 transition hover:-translate-y-0.5 hover:shadow-md">
      <div className="grid gap-4 p-4 sm:grid-cols-[170px_1fr_auto] sm:items-center">
        ...
        <div className="min-w-0">
          ...
          {!isFruit && (
  <p className={cx("mt-3 text-2xl font-black", current.accentText)}>
    {formatCurrency(item.price)}
        ...
        {isFruit ? (
          <div className="rounded-3xl border border-emerald-100 bg-white/90 p-3 shadow-sm sm:min-w-[180px]">
